...
public class TeacherRestController {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response uodateTeacher(@PathParam("teacherId") Long teacherId, TeacherUpdateDTO updateDTO)
    ...
    @Path("/{teacherId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getTeachers(@PathParam("teacherId") Long id) throws EntityNotFoundException {
    ...
    public Response getFiltered(@QueryParam("firstname") String firstname,
                                @QueryParam("lasname") String lastname,
                                @QueryParam("vat") String vat) {
        TeacherFiltersDTO filtersDTO = new TeacherFiltersDTO(firstname, lastname, vat);
        Map<String, Object> critiria;
        critiria = Mapper.mapToCritiria(filtersDTO);
        List<TeacherReadOnlyDTO> readOnlyDTOS = teacherService.getTeachersByCriteria(critiria);
